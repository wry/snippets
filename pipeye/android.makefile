...
CFLAGS   += --sysroot=$(SYSROOT) -I$(SYSROOT)/include -fPIE -pie -fPIC -DHAS_NO_GETLINE
CXXFLAGS += --sysroot=$(SYSROOT) -I$(SYSROOT)/include -fPIE -pie -fPIC -DHAS_NO_GETLINE -std=c++11 -I$(STL_PATH)/libs/armeabi-v7a/include -I$(STL_PATH)/include
